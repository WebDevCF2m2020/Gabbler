                    ...
                    <html lang="fr">
                        ...
                        <div style="background-color: #CED4DA; width: 80%; height: auto; padding:5%; border-radius: 15px; margin:50px auto; ">
                            ...
                            <div style="margin-bottom: 45px;">
                                <a href="https://glabberdev.webdev-cf2m.be/index.php/?action=registration&for=' . urlencode($au_signUpNickname) . '&key=' . urlencode($au_registrationArray['confirmation_key_user']) . '" style="text-decoration: none; color: #E41537; font-weight: 300;">https://glabberdev.webdev-cf2m.be/index.php/?action=registration&for=' . urlencode($au_signUpNickname) . '&key=' . urlencode($au_registrationArray['confirmation_key_user']) . '</a>
                            </div>
